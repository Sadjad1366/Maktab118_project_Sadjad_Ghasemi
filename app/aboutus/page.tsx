    ...
    <div className="bg-ingersoll-pattern">
      <div className="opacity-90">
        ...
        <section className="bg-gray-400 py-16 px-6 rtl">
          ...
          <p className="mt-6 text-xl text-gray-700 max-w-4xl mx-auto text-center">
            ما در گالری ساعت نینجا معتقدیم ساعت چیزی فراتر از یک ابزار برای
            نمایش زمان است. ساعت نمادی از سبک، شخصیت و حتی میراث است. هدف ما
            ارائه مجموعه‌ای است که تمامی سلیقه‌ها را پوشش دهد و تجربه‌ای لذت‌بخش
            از خرید آنلاین ساعت برای شما فراهم کند.
          </p>
          ...
          <div className="container mx-auto px-6 flex flex-col md:flex-row items-center gap-10">
            ...
            <div className="md:w-1/2 text-gray-900">
              ...
              <p className="text-lg text-gray-800 leading-relaxed">
                گالری ساعت نینجا از سال 1378 فعالیت خود را آغاز کرد. با هدف ایجاد پلی
                میان مد، تکنولوژی و نوآوری، توانستیم اعتماد هزاران مشتری را به دست
                آوریم. امروز مفتخریم که یکی از پیشروترین فروشگاه‌های آنلاین در
                صنعت ساعت هستیم.
              </p>
